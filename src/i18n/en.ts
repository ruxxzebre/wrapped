...
export const en = {
	...
	"detail.vsAverage": "{x}× your average",
	"track.playsPerMonth": "Plays per month",
	"track.whenYouPlay": "When you play it (hour of day)",
	"track.byWeekday": "When you play it (day of week)",
	"track.completion": "Completion",
	"track.howItStarts": "How it starts",
	"track.howItEnds": "How it ends",
	"track.platforms": "Platforms",
	"track.countries": "Where you listened",
	"track.completionTrend": "Did you finish it? (by year)",
	"track.rankByYear": "Chart position by year",
	"track.leadsInto": "Leads into",
	"track.comesBefore": "Comes before",
	"track.segueCount": "times",
	"track.originTitle": "How it began",
	"track.originLine": "First heard on {weekday}, {date}.",
	"track.originGateway": "Right after {gateway}.",
	"track.season": "season-locked",
	"track.onRepeat": "on repeat",
	"track.bingeDays": "binge days",
	"track.bingeDaysSub": "3+ plays in a day",
	"track.fullListens": "full listens",
	"track.fullListensSub": "end-to-end equivalents",
	"track.timesFinished": "times finished",
	"track.timesFinishedSub": "played to the end",
	"track.lastPlayed": "last played",
	"track.daysAgo": "{n}d ago",
	"track.milestone": "milestone",
	"track.shuffleShare": "on shuffle",
	"track.shuffleSub": "of plays were shuffled",
	"track.skipSplit":
		"Skips {shuffle} on shuffle vs {intent} when you choose it.",
	"track.comebackTitle": "Rediscovery",
	"track.comebackLine": "Went quiet for {gap}, then {n} plays in 30 days.",
	...
	// --- reason_end codes --------------------------------------------------
	"reasonEnd.trackdone": "Played to the end",
	"reasonEnd.fwdbtn": "Skipped forward",
	"reasonEnd.backbtn": "Jumped back",
	"reasonEnd.endplay": "Stopped playback",
	"reasonEnd.logout": "Logged out",
	"reasonEnd.remote": "Remote / cast device",
	"reasonEnd.trackerror": "Track error",
	"reasonEnd.unexpected-exit": "App closed",
	"reasonEnd.unexpected-exit-while-paused": "Closed while paused",
	"reasonEnd.?": "Unknown",
} as const;
