...
import type { Metric, Period, TopAlbum } from "../api";
...
const columns = (t: TFunction): VColumn<TopAlbum>[] => [
	{
		key: "rank",
		header: t("col.rank"),
		size: "3rem",
	...
	},
	{
		...
		cell: (a) => <AlbumLink album={a.album} artist={a.artist} />,
	},
	{
		key: "artist",
		header: t("col.artist"),
		size: "minmax(140px,1.4fr)",
		cell: (a) => <ArtistLink name={a.artist} muted />,
	},
	{
		key: "plays",
		header: t("col.plays"),
...
export default function TopAlbums() {
	...
	const query = useInfiniteQuery(q.topAlbums(metric, period));
